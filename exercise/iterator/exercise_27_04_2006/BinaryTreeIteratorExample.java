...
class BinaryTreeNode<T extends Number> {
    ...
    // TODO
    private class BinaryPostIterator implements Iterator<BinaryTreeNode<T>> {
        private LinkedList<BinaryTreeNode<T>> toVisit = new LinkedList<>();

        public BinaryPostIterator(BinaryTreeNode<T> t) {
            toVisit.addFirst(t);
        }
    ...
    // TODO
    private class BinaryInIterator implements Iterator<BinaryTreeNode<T>> {
        private LinkedList<BinaryTreeNode<T>> toVisit = new LinkedList<>();

        public BinaryInIterator(BinaryTreeNode<T> t) {
            toVisit.addFirst(t);
        }
